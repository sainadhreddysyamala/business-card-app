...
export default async function Home() {
  ...
  const capServiceUrl = "https://community-challenge.cfapps.us10.hana.ondemand.com/";
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-6 bg-slate-900 text-white">
      ...
      <div className="w-full max-w-sm text-center">
        ...
        <h1 className="text-2xl font-bold">Sai Nadh Reddy Syamala</h1>
        <p className="text-slate-400 mb-6">SAP CPI Developer</p>
        ...
        <div className="flex flex-col gap-3">
          ...
          <form action={submitToCap}>
            <input type="hidden" name="communityId" value="Sai_12-1" />
